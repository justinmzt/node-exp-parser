module.exports = {
    exp: [
        ...
        [
            ...
            '{"b":[1],"c":[2],"a":["2010-12-30T16:00:00.000Z","2010-12-31T16:00:00.000Z"],"d":["test"]}',
        ], // 联合测试日期和 not
        [
            'b: 1 and c:2 and not (a:TIME("2010/12/31*") and d: "test")',
            'b: 1 and c: 2 and not (a: TIME("2010/12/31*") and d: "test")',
        ...
        [
            ...
            '{"a":["2010-10-11T07:00:00.000Z"]}',
        ], // 日期小于等于结合时间段查询
        [
            'a<=TIME("2010*","2011*")',
            'a <= TIME("2010*", "2011*")',
            '{"a":{"$lte":"2011-12-31T16:00:00.000Z"}}',
            '{"a":["2011-12-31T16:00:00.000Z"]}',
        ], // 日期小于等于结合年份模糊时间段查询
        [
            'a<=TIME("2010/11*","2011/12*")',
            'a <= TIME("2010/11*", "2011/12*")',
        ...
        [
            ...
            '{"a":["2009-12-31T16:00:00.000Z"]}',
        ], // 日期大于结合年份模糊时间段查询
        [
            'a>TIME("2010/11*","2011/12*")',
            'a > TIME("2010/11*", "2011/12*")',
            '{"a":{"$gt":"2010-10-31T16:00:00.000Z"}}',
            '{"a":["2010-10-31T16:00:00.000Z"]}',
        ], // 日期大于结合仅年月模糊时间段查询
        [
            'a>TIME("2010/11/30*","2010/12/31*")',
            'a > TIME("2010/11/30*", "2010/12/31*")',
            '{"a":{"$gt":"2010-11-29T16:00:00.000Z"}}',
            '{"a":["2010-11-29T16:00:00.000Z"]}',
        ], // 日期大于结合仅日期跨月模糊时间段查询
        [
            'a:1 and (b: "test")',
            'a: 1 and b: "test"',
